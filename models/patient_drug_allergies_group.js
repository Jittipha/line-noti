...
const patientDrugAllerrgiesGroupSchema = new mongoose.Schema({
    ALEVEL : {type : String,required : true}, //
    GENERIC_GROUP : {type : String,required : true}, //
    HN : {type : String},
...
module.exports = mongoose.model('patient_drug_allergies_group',patientDrugAllerrgiesGroupSchema)
